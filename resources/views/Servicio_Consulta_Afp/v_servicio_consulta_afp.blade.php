...
<html lang="en">
  ...
  <body style="padding: 10px">
    ...
    <div class="container">
        <div class="row">
            <span style="color:rgb(27, 102, 201);font-weight:bold">Consulta de Afp </span><br>
            ...
            <div class="col">               
                <div class="shadow-lg p-3 mb-5 mt-4 bg-body rounded">                                    
                    <form class="row g-3">
                        ...
                        <div class="col-12">
                        <button class="btn btn-warning fw-none float-end btnConsultarAfp" type="button">Consulta <b>Afp</b></button>
                        </div>
                    </form>
                </div>
            </div>
		...
		$.post('{{asset('serv_afp/fun_obtener_afp')}}',
			...
			function(data){
				...
				if(elem == null || elem == undefined ) {
					console.log('fail');
					//alert(data);
					alert('Error - Consulta AFP - No se ha encontrado ningún afiliado con el documento de identidad ingresado. -warning');
